        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-6">
              <Link
                to="/"
                className="flex items-center gap-3 text-xl font-medium text-gray-900 dark:text-gray-100 hover:text-gray-700 dark:hover:text-gray-300 transition-colors"
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                variant="ghost"
                size="sm"
                className="hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors h-9 w-9"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card className="border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
              ...
              <CardContent className="pb-4">
                <div className="text-3xl font-medium text-gray-900 dark:text-gray-100 mb-2 tracking-tight">
                  {stats.totalNovels}
                </div>
                <div className="flex items-center gap-2">
            ...
            <CardContent className="pt-2">
              {mockNovels.length === 0 ? (
                <div className="text-center py-16">
                  ...
                  <h4 className="text-lg font-medium mb-3 text-gray-900 dark:text-gray-100 tracking-tight">
                    开始创作您的第一部小说
                  </h4>
                  ...
                  <Button
                    asChild
                    size="lg"
                    className="bg-gray-900 dark:bg-gray-100 hover:bg-gray-800 dark:hover:bg-gray-200 text-white dark:text-gray-900 transition-colors rounded-lg"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {mockNovels.slice(0, 6).map((novel) => (
                    <Card
                      key={novel.id}
                      className="group cursor-pointer border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                    >
