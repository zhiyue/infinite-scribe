...
const EmailVerificationPage: React.FC = () => {
          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription className="success-message text-green-500">
                Your email address has been verified. You will be redirected to the login page
                shortly.
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="space-y-4">
                {errorMessage && (
                  <div className="rounded-md bg-destructive/15 p-3" role="alert">
                    <div className="text-sm text-destructive error-message">{errorMessage}</div>
                  </div>
                )}
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md">{renderVerificationContent()}</div>
    </div>
  )
}
