...
class RateLimitService:
    ...
    def check_rate_limit(
        ...
        reset_time = datetime.fromtimestamp(requests[0] + window) if requests else datetime.utcnow() + timedelta(seconds=window)
    ...
    def get_client_key(self, request, user_id: Optional[str] = None) -> str:
