...
- [多智能体网络小说自动写作系统 全栈架构文档](#table-of-contents)
  ...
  - [Data Models](./data-models.md)
    ...
    - [GenesisStep (创世步骤) - PostgreSQL](./data-models.md#genesisstep-创世步骤-postgresql)
  ...
  - [Core Workflows](./core-workflows.md)
    ...
    - [3. SSE实时更新流程 (SSE Real-time Update Flow)](./core-workflows.md#3-sse实时更新流程-sse-real-time-update-flow)
  - [REST API Spec](./rest-api-spec.md)
  - [Database Schema](./database-schema.md)
    - [PostgreSQL](./database-schema.md#postgresql)
      - [混合外键策略说明](./database-schema.md#混合外键策略说明)
