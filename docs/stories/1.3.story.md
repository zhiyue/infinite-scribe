...
Local Test Steps:
- 运行单元测试: `./scripts/run-tests.sh`
- 运行集成测试: `./scripts/run-tests.sh --integration`
- 运行测试并生成覆盖率报告: `./scripts/run-tests.sh --coverage`
...
- Subtask 5.2 was skipped as it requires deployment to the development server
