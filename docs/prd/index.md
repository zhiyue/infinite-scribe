...
- [多智能体网络小说自动写作系统(InfiniteScribe) 产品需求文档 (PRD)](#table-of-contents)
  ...
  - [Epic 2: AI驱动的创世工作室 (AI-Driven Genesis Studio)](./epic-2-ai驱动的创世工作室-ai-driven-genesis-studio.md)
    - [Story 2.1: 设计并实现创世数据模型](./epic-2-ai驱动的创世工作室-ai-driven-genesis-studio.md#story-21-设计并实现创世数据模型)
    - [Story 2.2: 实现支持双入口模式和SSE的创世API](./epic-2-ai驱动的创世工作室-ai-driven-genesis-studio.md#story-22-实现支持双入口模式和sse的创世api)
    - [Story 2.3: 进化“世界铸造师Agent”以处理混合输入](./epic-2-ai驱动的创世工作室-ai-driven-genesis-studio.md#story-23-进化世界铸造师agent以处理混合输入)
    - [Story 2.4: 构建支持双入口和SSE的“创世工作室”UI](./epic-2-ai驱动的创世工作室-ai-driven-genesis-studio.md#story-24-构建支持双入口和sse的创世工作室ui)
