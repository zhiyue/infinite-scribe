...
SERVICES = {
    ...
    "outliner-agent": {"module": "apps.outliner-agent.agent.main", "command": "python -m {module}"},
    "director-agent": {"module": "apps.director-agent.agent.main", "command": "python -m {module}"},
    ...
    "writer-agent": {"module": "apps.writer-agent.agent.main", "command": "python -m {module}"},
    "critic-agent": {"module": "apps.critic-agent.agent.main", "command": "python -m {module}"},
    "factchecker-agent": {
        "module": "apps.factchecker-agent.agent.main",
        "command": "python -m {module}",
    },
    "rewriter-agent": {"module": "apps.rewriter-agent.agent.main", "command": "python -m {module}"},
}
